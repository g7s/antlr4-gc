...
goog.module('org.antlr.v4.runtime.IntStream');
...
class IntStream {
     ...
     *
     * @throws {Error} if an attempt is made to consume the
     ...
     * @param {number} i
     * @return {number}
     * @throws {Error} if the stream does not support
     ...
     * </pre>
     *
     * @return {number} An opaque marker which should be passed to
     ...
     * was constructed.
     *
     * @param {number} index The absolute index to seek to.
     *
