...
/**
 * This module provides access to the current version of the ANTLR 4 runtime
 ...
 */
exports.getRuntimeVersion = function () {
    return VERSION;
};
 ...
 * @return {string} A string of the form <em>major</em>.<em>minor</em> containing
 ...
 *
 * @param {?string} generatingToolVersion The version of the tool used to generate a parser.
 * This value may be null when called from user code that was not generated
 * by, and does not reference, the ANTLR 4 Tool itself.
 * @param {string} compileTimeVersion The version of the runtime the parser was
 * compiled against. This should always be passed using a direct reference
 * to {@link #VERSION}.
 * @return {void}
 */
exports.checkVersion = function (generatingToolVersion, compileTimeVersion) {
