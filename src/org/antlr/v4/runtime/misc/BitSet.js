...
BitSet.prototype = {
     ...
     * res = bs1.not();
     *
     * @return {BitSet} A new BitSet object, containing the bitwise NOT of this
     */
    not: function() { // invert()
        var t = this.clone();
        var d = t.data;
     ...
     * @return {BitSet} A new BitSet object, containing the bitwise AND of this and value
     */
     ...
     * @return {BitSet} A new BitSet object, containing the bitwise OR of this and val
     */
     ...
     *
     * @param {BitSet} val A bitset object
     * @return {BitSet} A new BitSet object, containing the bitwise XOR of this and val
     */
     ...
     *
     * @param {BitSet} val A bitset object
     * @return {BitSet} A new BitSet object, containing the bitwise AND NOT of this and other
     */
     ...
     * @return {BitSet} A new smaller bitset object, containing the extracted range
     */
     ...
     * bs1.isEmpty() ? 'yes' : 'no'
     *
     * @return {boolean} Whether the bitset is empty
     */
    isEmpty: function() {
        if (this._ !== 0)
        return false;
     ...
     *
     * @return {number} The index of the highest bit set
     */
    msb: Math['clz32'] ?
    function() {
        if (this._ !== 0) {
     ...
     * var ntz = bs1.ntz();
     *
     * @return {number} The index of the lowest bit set
     */
    ntz: function() {
        var data = this.data;
     ...
     *
     * @param {BitSet} val A bitset object
    * @return {boolean} Whether the two BitSets have the same bits set (valid for indefinite sets as  well)
     */
    equals: function(val) {
